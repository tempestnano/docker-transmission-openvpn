...
RUN echo "@testing http://dl-cdn.alpinelinux.org/alpine/edge/testing" >> /etc/apk/repositories \
    ...
    && unzip -q openvpn.zip -d /etc/openvpn/pia \
    && unzip -q openvpn-strong.zip -d /etc/openvpn/pia/strong \
    && unzip -q openvpn-tcp.zip -d /etc/openvpn/pia/tcp-normal \
    && unzip -q openvpn-strong-tcp.zip -d /etc/openvpn/pia/tcp-strong \
    && rm *.zip \
    && echo "Purging" \
    && apk update \
    && apk del --purge unzip \
